...
# ]
EVALUATION_QUESTIONS = [
    "Перечисли все три типа памяти, которые выделяют в AI-ассистентах, и кратко опиши их назначение",
    "Какие виды галлюцинаций могут возникать у языковых моделей и чем они отличаются?",
    "Что именно можно кэшировать в RAG-системах и какой эффект дает каждый из уровней кэширования?",
    "Какие метрики качества RAGAS требуют наличия эталонного ответа (Ground Truth), а какие оценивают систему без него?",
    "Из каких этапов состоит процесс подготовки данных для RAG и что происходит на этапе очистки?"
]
